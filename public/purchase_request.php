...
<div class="main" id="main">
    <div class="filter-download_container">
        <div class="filter_options_container">
            ...
            <div class="label_input__container filter-container">
                <select name="document_type" id="filterInputType" class="filterInputType" onchange="filterNameFunctionType()" required>
        ...
        <div class="btn warning btn-flex btn-nowrap popupForm-add btn-pad">
            <img src="assets/icons/add-icon.png" alt="">
            <a id="openPopup">New Document</a>
        </div>
    </div>
                    ...
                    <div class="popupForm-body__container">
                        <div class="form-container">
                            ...
                            <div class="label-input__container">
                                ...
                                <input type="text" name="document_sender" id="encoding_document_sender" value="" placeholder="Sender" required>
                            </div>
                            <div class="label-input__container">
                                <label for="">Intended Receiver</label>
                                <input type="text" name="document_receiver" id="encoding_document_receiver" value="" placeholder="Intended Receiver" required>
                            </div>
 ...
 !!this.value && Math.abs(this.value) >= 1 ? Math.abs(this.value) : null" name="document_pages" value="1" placeholder="No. of Pages" required>
    ...
    <div class="content-wrapper">
        <table class="table content_table" id="my-Table">
            <thead>
                <th>Requesting Office/Section</th>
                <th>PR No.</th>
            ...
            <tr>
                <?php
                while ($row = $fetch_pending_data->fetch(PDO::FETCH_ASSOC)) {
                    $dataList = [];
                ?>
                    <form action="#" method="POST">
                        ...
                        ?>
                        <td data-label="">
                            <button class="btn warning" name="btn-gen-slip" value="" type="button" onclick='passItem(<?php echo json_encode($dataList); ?>, "<?php echo $row['document_id']; ?>"); window.print();'>Print</button>
                        </td>
                    </form>
            </tr>
        <?php
        ...
        <div class="pagination">
            <div class="pagination_container">
                <?php
                if ($fetch_pending_data->rowCount() < 1) {
