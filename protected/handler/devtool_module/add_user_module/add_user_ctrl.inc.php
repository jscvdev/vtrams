...
function is_add_user_required_data_empty(array $variables_to_check)
{
    $empty_variables = [];
...
{
    add_new__account($pdo, $emp_id, $emp_fn, $emp_mi, $emp_ln, $hashedPwd, $section, $division, $formattedPosition, $access_level, $udc, $office, $emp_tag);
}