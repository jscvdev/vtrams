...
{
    return voucher_document_user_action($pdo, $processing_no, $ors_no, $ada_check_no, $dv_no, $payee, $address, $tin_employee_no, $particulars, $amount, $voucher_type, $voucher_date,
