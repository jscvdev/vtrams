...
function voucher_remove_voucher(object $pdo, string $processing_no, string $dv_no)
{
    remove_from_temp_vouchers($pdo, $processing_no, $dv_no);
}

function voucher_remove_from_temp(
    object $pdo,
